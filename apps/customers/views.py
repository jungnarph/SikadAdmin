...
def convert_firebase_timestamp(timestamp_ms):
    """
    Convert Firebase timestamp in milliseconds to timezone-aware datetime object

    Args:
        timestamp_ms: Timestamp in milliseconds (e.g., "1761463104006" or 1761463104006)
    ...
    try:
        ...
        # Make timezone-aware using Django's timezone (respects USE_TZ setting)
